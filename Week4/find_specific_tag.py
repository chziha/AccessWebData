...
that is in a particular position relative to the first name in the list,
...
Actual problem: Start at: http://py4e-data.dr-chuck.net/known_by_Samir.html
...
def find_specific_tag(url):
    ...
    for i in range(count):
        ...
        url = tag.get('href')
        print(tag.get_text())
    print('Last name in sequence: ', tag.get_text())

if __name__ == '__main__':
    find_specific_tag(url)
